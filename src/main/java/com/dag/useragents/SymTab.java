 ...
 */ 
public class SymTab {
  Map<String,Yytoken> m;   // contains the list of words
  ...
  public SymTab(SymTab p) {
    m = new HashMap<String,Yytoken>();
    pred = p;
  }

  public boolean enter(String s, Yytoken e) {
    Object value = lookup(s);
    m.put(s, e);
    return(value==null);
  }

  public Yytoken lookup(String s) {
    Yytoken value = m.get(s);
  ...
  public String toString() {    // for output with print
    ...
    for (Map.Entry<String,Yytoken> entry : m.entrySet())
